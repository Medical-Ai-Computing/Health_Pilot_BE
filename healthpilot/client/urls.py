...
# router.register('users_emergency', UserEmergencyContactAPIView, basename='user_emergency_contact')
router.register('users/(?P<users_pk>[^/.]+)/users_emergency', UserEmergencyContactAPIView, basename='user_emergency_contact')
...
emergency_contact_router.register('users_emergency', UserEmergencyContactAPIView, basename='user_emergency_contact')
